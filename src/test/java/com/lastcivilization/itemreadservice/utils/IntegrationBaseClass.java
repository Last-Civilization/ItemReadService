...
import com.lastcivilization.itemreadservice.infrastructure.application.ItemReadServiceApplication;
...
@SpringBootTest(classes = ItemReadServiceApplication.class, webEnvironment = RANDOM_PORT, properties = "test.url=http://localhost:9561")
@Testcontainers
